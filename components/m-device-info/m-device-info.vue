<template>
	<cover-view class="m-device-info text-size-md bg-white rounded padding-3 d-flex align-items-center" v-if="coverView">
		<cover-view class="left flex-2 overflow-hidden">
			<cover-view class="d-flex align-items-center">
				<cover-view class="text-000">{{ deviceName }}</cover-view>
				...
				<cover-view class="text-999 text-size-sm">（{{ deviceType === 0 ? '两轮电车桩' : '电动汽车桩' }}）</cover-view>
			</cover-view>
	...
	<!-- view -->
	<view class="m-device-info text-size-md bg-white rounded padding-3 d-flex align-items-center" v-else>
		<view class="left flex-2 overflow-hidden">
			<view class="d-flex align-items-center margin-bottom-1">
				<view class="text-000 text-truncate">{{ deviceName }}</view>
		...
		<view class="right flex-1 border-left-1" @click="openLocation">
			<view class="d-flex justify-content-center align-items-center margin-bottom-2 positon-icon-box">
				<m-icon-image name="position" className="position-icon" size="40rpx"></m-icon-image>
			</view>
			<view class="text-size-sm text-333 d-flex justify-content-center align-items-center">
				<view class="d-flex justify-content-center align-items-center">
					...
					<view class="view-primary text-success">{{ distance }}</view>
